          ...
          <>
            ...
            >
              <div className="flex flex-col gap-2">
                ...
                <h2 id="create-task-heading" className="text-2xl font-bold">
                  Create task
                </h2>
                ...
                >
                  Write a clear task that someone in the project can
                  understand, take ownership of and move forward through the
                  workflow.
                </p>
              ...
              <div className="mt-6 grid gap-5 md:grid-cols-4">
                <div>
                  ...
                  <input
                    ...
                    value={taskTitle}
                    onChange={(event) =>
                      handleTaskTitleChange(event.target.value)
                    }
            ...
            {tasks.length === 0 && <WorkspaceEmptyState />}
  ...
  return (
    <section className="rounded-3xl border border-dashed border-rose-500/40 bg-rose-500/10 p-6">
      ...
      <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-300">
        Workspace needs an active project before tasks can be created. Go to My
